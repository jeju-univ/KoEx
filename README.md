...
# 코익스 사용에 대하여
   ...
   - 동작하던 기능이 갑자기 동작하지 않을 수 있습니다.
   - 코익스는 코러스 기반하여 할 수 있는 범위에서 기능을 확장한 것으로 이외의 기능 추가는 사실상 어렵습니다.
   - 코익스는 코러스를 사용하는 한 개인이 제작한 프로그램으로 향후 오류개선이나 대처가 없을 수 있습니다. 문제 발생시 확장프로그램 사용을 중단하세요.
   - 그럼에도 불구하고 **탭기능**만으로도 활용 가치는 충분히 있는것 같습니다.
   - 코익스 확장프로그램은 코러스 접속가능환경에서만 동작하며, 개인정보 또는 특별히 보안적으로 비공개되어야 할 기술을 사용하지 않습니다.
   - 문제발생시 aawoon@jejunu.ac.kr로 메일 주시면 가능한 대처는 하겠습니다만 개인일정 및 버전관리 문제등으로 어려울 수도 있습니다.
   - 향후 코러스 기능개선시 탭기능 및 문서검색, 개인편철 기능은 가능한 추가되었으면 하는 바랍니다.
