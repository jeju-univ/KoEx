...
코익스는 코러스 운영센터에서 공식 관리하는 프로젝트가 아니며, 개인이 관리하는 프로젝트입니다.

<br><br>

# 📜 플러그인 제작배경
  `코러스 시스템`은 지속적으로 유지관리가 되고 있지만 `코러스 업무관리(전자결재)`의 경우 패키지 형태로 제공되는 서비스이다보니 
  각종 기능개선 요구가 반영되기 어려운것 같습니다.
  최근 ChatGPT, Claude, cursor AI  등 AI를 활용한 코딩이 매우 쉬워지고 있어 이를 활용하여 전문분야가 아닌 플러그인개발을 해보게 되었습니다.

<br><br>

# 📥 KoEx(코익스) 설치방법
  코익스는 크롬 웹 스토어에 비공개(링크가 있어야만 설치가능)로 등록되어 있습니다.
  - 화면 맨 하단에 링크가 안내되어 있습니다. 본 문서를 모두 읽어보시고 설치바랍니다.
...
# 🙋‍♀️ 문의하기
- 각종 문의는 제주대학교 디지털정보실 ( aawoon@jejunu.ac.kr )로 주세요.
- 개인이 관리하는 프로젝트라서 대응이 느릴 수 있습니다.
※ 코러스 운영센터에서는 관련 문의를 받지 않습니다.
